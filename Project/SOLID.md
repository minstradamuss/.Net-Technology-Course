...
```c#
// AuthService овечает только за аутентификацию, а хэширование паролей выделено в отдельный класс IHashingStrategy
...
```c#
// Добавление новых стратегий хэширования без изменения существующего кода
